...
import com.zxgs.support.Group;
import com.zxgs.support.Item;
...
//	}
	...
	private void loadSystemParameter(ServletContext servletContext) {
		...
		try {
			...
			Set<String> set=SystemCache.DICTIONARY.keySet();
			Map map=SystemCache.DICTIONARY;
			Group gg=(Group) map.get("SYSUSER_ROLE");
			System.out.println();
